...
public class SortingPractice {
    ...
    static int[] iterativeMergeSort(int[] array) {
      ...
      // partition an array first into sub arrays of size 1
        ...
        // merged calls for sub arrays of size 2
        int k= 0;
          array [k] =  array [0];
         array[k+1] = array[1];
         ...
         for (int m =0; m< array.length; m++) {
            array[k+m] = array [m];
             ...
             // loop increment = 2x size of sub array
             // Will determine the size of the array
             // must be a power of 2
             for (int size = 1; size <= array.length/2; size= size*2) {

               //merge function
               // partition the array into pairs of 2-element arrays until its fully sorted

                   for (int i = 0; i < array.length;  i= i+2 * size) {
                       int[] left = slice(array, i, i + size);
                       int[] right = slice(array,  i +size , i + size + size);
                       ...
                       merge(slice(left, 0, 4), slice(right,  4, 8));}
